  ...
  EpicEditor.prototype.load = function (callback) {
    ...
    self._goFullscreen = function (el) {
      ...
      if (!nativeFs) {
        ...
        cbNavWidth = document.getElementById('mainNav').clientWidth;
        windowOuterWidth = windowOuterWidth - cbNavWidth;
        windowInnerWidth = windowInnerWidth - cbNavWidth;
      }
      ...
      // Display exit fullscreen button
      if (self.settings.button.bar == true) {
        utilBtns.getElementsByClassName("epiceditor-fullscreen-btn")[0].style.visibility = 'visible';
      }
